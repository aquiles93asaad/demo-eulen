...
.provider('SearchServices', function() {
    ...
    this.$get = ['$q', '$http', '$timeout', '$rootScope', 'WS_EXP_COD_RET', 'WS_SUC_COD_RET', 'VALUES_SEPARATOR', 'VALUES_SEPARATOR_2',

        function($q, $http, $timeout, $rootScope, WS_EXP_COD_RET, WS_SUC_COD_RET, VALUES_SEPARATOR, VALUES_SEPARATOR_2) {
            /****************/
            /* PRIVATE METHODS
            /****************/
